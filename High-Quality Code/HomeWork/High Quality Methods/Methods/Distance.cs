namespace Methods
{
    ...
    {
        private const string PointCanNotBeNullMSG = "Point can not be null.";
        ...
        public double PointAX
        {
            ...
            set
            {
                if (value == null)
                {
                    throw new ArgumentException(PointCanNotBeNullMSG);
                }
        ...
        public double Value
        {
            get
            {
                double distanceValue = Math.Sqrt(
                    (
                        (this.PointBX - this.PointAX) * (this.PointBX - this.PointAX)
                    )
                    +
                    (
